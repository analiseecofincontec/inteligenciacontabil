...
openai.api_key = "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"
...
def analyze_data(data):
    try:
        response = openai.ChatCompletion.create(
            model="gpt-4",
            messages=[
                {"role": "system", "content": "Você é um analista contábil e financeiro e fará a análise de balancetes e DRE's,
...
Quando constar Adiantamento para Futuro Aumento de Capital, Lançamentos no passivo nessa conta devem ser monitorados e destacados para evitar 
irregularidades contábeis, enfatize bem os riscos de fazer este lançamento se ele não for de fato real.
